...
def checkCase(cards):
    ...
    return (case1 and case2) or (case2 and case3) or (case2 and case5) or (case3 and case4) or (case4 and case5)
...
def checkCase4(cards):
    if cards.count('3_eleplant_red') == 2 :
        return True

def checkCase5(cards):
    if cards.count('3_eleplant_black') == 2 :
        return True
...
for round in range(1, int(samapleSpace+1)):
    hoo_little_red_3 = ['4_boat_red', '5_horse_red', '6_biggun_red']
    players = []
    cards = deck()
