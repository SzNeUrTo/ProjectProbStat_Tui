...
for round in range(1, int(samapleSpace+1)):
    cards = deck()
    players = []
    cardsUpper = ['2_airplane_red', '2_airplane_black', '3_eleplant_red','3_eleplant_black','4_boat_red','4_boat_black','5_horse_red','5_horse_black','6_biggun_red','6_biggun_black','7_soldier_red']
    removeList = ['7_soldier_black']
